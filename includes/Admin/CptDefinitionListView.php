						...
						<?php foreach ( $definitions as $slug => $definition ) : ?>
							<tr>
								...
								<td class="eit-row-actions">
									<a class="eit-mini-button" href="<?php echo esc_url( admin_url( 'edit.php?post_type=' . rawurlencode( $slug ) ) ); ?>"><?php esc_html_e( 'Open items', 'elementor-implementation-toolkit' ); ?></a>
