	...
	public static function normalize_filters( array $filters ) {
		...
		foreach ( $filters as $index => $filter ) {
			...
			$normalized[] = [
				...
				'radioShowAll'  => ( $filter['radio_show_all'] ?? '' ) === 'yes',
				'radioAllLabel' => sanitize_text_field( $filter['radio_all_label'] ?? __( 'All', 'elementor-implementation-toolkit' ) ),
	...
	public static function map_preset_filters_to_widget_filters( array $filters ) {
		...
		foreach ( $filters as $index => $filter ) {
			...
			$mapped[] = [
				...
				'radio_show_all' => ! empty( $filter['radio_show_all'] ) ? 'yes' : '',
				'radio_all_label' => $filter['radio_all_label'] ?? __( 'All', 'elementor-implementation-toolkit' ),
